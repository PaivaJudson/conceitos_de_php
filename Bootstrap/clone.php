<html lang="en"><head>
    ...
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-JHDWF4FG2J&amp;l=dataLayer&amp;cx=c"></script><script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-156446909-2"></script>
    <script>
  ...
  <body data-aos-easing="ease-out-quad" data-aos-duration="700" data-aos-delay="0" cz-shortcut-listen="true">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="assets/img/illustrations/illustration-2.png" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0 aos-init aos-animate" alt="..." data-aos="fade-up" data-aos-delay="100">
    ...
    <section class="pt-8 pt-md-11 bg-gradient-light-white">
      <div class="container">
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          <div class="col-12 col-md-6 order-md-2 aos-init" data-aos="fade-left">

            <!-- Heading -->
            <h2>
              The most useful resource <br>
              <span class="text-success">ever created for <span data-typed="{&quot;strings&quot;: [&quot;developers.&quot;, &quot;founders.&quot;, &quot;designers.&quot;]}">developers.</span><span class="typed-cursor typed-cursor--blink" aria-hidden="true">|</span></span>
            </h2>
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1 aos-init" data-aos="fade-right">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-7 col-lg-6 aos-init" data-aos="fade-right">
            ...
            <div class="card card-row shadow-light-lg mb-6">
              <div class="row gx-0">
                <div class="col-12 col-md-6">
                  ...
                  <!-- Slider -->
                  <div class="card-img-slider flickity-enabled is-fade" data-flickity="{&quot;fade&quot;: true, &quot;imagesLoaded&quot;: true, &quot;pageDots&quot;: false, &quot;prevNextButtons&quot;: false, &quot;asNavFor&quot;: &quot;#blogSlider&quot;, &quot;draggable&quot;: false}" tabindex="0">
                    
                    
                  <div class="flickity-viewport" style="height: 434.828px;"><div class="flickity-slider" style="transform: translateX(50%);"><a class="card-img-start position-absolute d-block w-100 bg-cover flickity-cell is-selected is-nav-selected" style="background-image: url(&quot;assets/img/photos/photo-1.jpg&quot;); transform: translateX(-50%); opacity: 1;" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">

                    </a><a class="card-img-start position-absolute d-block w-100 bg-cover flickity-cell" style="background-image: url(&quot;assets/img/photos/photo-26.jpg&quot;); transform: translateX(-50%); opacity: 0;" href="#!" aria-hidden="true">
                ...
                <div class="col-12 col-md-6 position-md-static">
                  ...
                  <!-- Slider -->
                  <div class="position-md-static flickity-enabled is-draggable" data-flickity="{&quot;wrapAround&quot;: true, &quot;pageDots&quot;: false, &quot;adaptiveHeight&quot;: true}" id="blogSlider" tabindex="0">
                    
                    
                  <div class="flickity-viewport" style="height: 299.336px;"><div class="flickity-slider" style="transform: translateX(0%);"><div class="w-100 flickity-cell is-selected" style="transform: translateX(0%);">
                    ...
                    </div></div></div><button class="flickity-button flickity-prev-next-button previous" type="button" aria-label="Previous"><svg class="flickity-button-icon" viewBox="0 0 100 100"><title>Previous</title><path d="M 10, 50
    L 60, 100
    L 70, 90
    L 30, 50
    L 70, 10
    L 60, 0
    Z" class="arrow"></path></svg></button><button class="flickity-button flickity-prev-next-button next" type="button" aria-label="Next"><svg class="flickity-button-icon" viewBox="0 0 100 100"><title>Next</title><path d="M 10, 50
    L 60, 100
    L 70, 90
    L 30, 50
    L 70, 10
    L 60, 0
    Z" class="arrow" transform="translate(100, 100) rotate(180)"></path></svg></button></div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1">
            ...
            <div class="d-flex">
              <div class="pe-5">
                <h3 class="mb-0">
                  <span data-countup="{&quot;startVal&quot;: 0}" data-to="100" data-aos="" data-aos-id="countup:in" class="aos-init"></span>%
                </h3>
              ...
              <div class="px-5">
                <h3 class="mb-0">
                  <span data-countup="{&quot;startVal&quot;: 0}" data-to="24" data-aos="" data-aos-id="countup:in" class="aos-init"></span>/
                  <span data-countup="{&quot;startVal&quot;: 0}" data-to="7" data-aos="" data-aos-id="countup:in" class="aos-init"></span>
                </h3>
                <p class="text-gray-700 mb-0">
                  Support
                </p>
              ...
              <div class="ps-5">
                <h3 class="mb-0">
                  <span data-countup="{&quot;startVal&quot;: 0}" data-to="100" data-aos="" data-aos-id="countup:in" class="aos-init"></span>k+
                </h3>
                <p class="text-gray-700 mb-0">
                  Sales
                </p>
      ...
      <div class="container">
        ...
        <div class="row align-items-center gx-0">
          <div class="col-12 col-md-6">
            ...
            <!-- Card -->
            <div class="card rounded-lg shadow-lg mb-6 mb-md-0 aos-init" style="z-index: 1;" data-aos="fade-up">
          ...
          <div class="col-12 col-md-6 ms-md-n3">
            ...
            <!-- Card -->
            <div class="card rounded-lg shadow-lg aos-init" data-aos="fade-up" data-aos-delay="200">
    ...
    <!-- Theme JS -->
    <script src="./assets/js/theme.bundle.js"></script><style type="text/css" data-typed-js-css="true">
        .typed-cursor{
          opacity: 1;
        }
